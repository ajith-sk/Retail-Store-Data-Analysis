...
Top products and Top 10 customers analysis
...
Bar & Column Charts (Category & Product Sales)

Tables (Customer insights)

Pie & Donut Charts (Payment Type, Discount Applied)
...
Sales decline in the final quarter, indicating possible seasonality.

Payment methods are evenly split across Cash, Credit Card, and Digital Wallets.

Discounted transactions occur nearly twice as often as non-discounted sales, highlighting strong promotion dependency.
...
Skilled in SQL, Python, Power BI, and Excel, with hands-on experience in transforming data into business insights and an interest in combining cloud technologies with analytics.
